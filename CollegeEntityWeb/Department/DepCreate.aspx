<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="DepCreate.aspx.cs" Inherits="Department_DepCreate" %>
                            ...
                            <table border='0' cellpadding="4" width="80%">
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnDepartment" runat="server" CssClass="button-new"
                                            Text="Create Department" OnClientClick="return checkfield();" OnClick="btnDepartment_Click" ></asp:Button>
