<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="TeacherEdit.aspx.cs" Inherits="Teacher_TeacherEdit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Teacher Edition</title>
    ...
    <script type="text/javascript">
        ...
        function checkfield() {
            ...
            var txtTeachercode = $('#<%=txtTeachercode.ClientID%>').val();
            if (txtTeachercode == "") {
                jAlert('Kindly Enter Teacher Code', 'Alert Dialog');
                $('#<%=txtTeachercode.ClientID%>').focus();
                return false;
            }
        ...
        <tr>
            <td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width: 60%; padding-left: 20px;" class="Page_Header"><b>Teacher Edition</td>
                    </tr>
                </table>
                        ...
                        <td align="center">
                            ...
                            <table border='0' cellpadding="4" width="90%">
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtTeachercode" runat="server" CssClass="textbox" Width="135px"></asp:TextBox>
                                    </td>
                                </tr>
                                 <tr>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnEditionTeacher" runat="server" CssClass="button-new"
                                            Text="Update" OnClientClick="return checkfield();" OnClick="btnEditionTeacher_Click" ></asp:Button>&nbsp;&nbsp;
