<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="CreateTeacher.aspx.cs" Inherits="Teacher_CreateTeacher" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkfield() {
            ...
            var txtTcode = $('#<%=txtTcode.ClientID%>').val();
            if (txtTcode == "") {
                jAlert('Kindly Enter Teacher Code', 'Alert Dialog');
                $('#<%=txtTcode.ClientID%>').focus();
                return false;
            }
        ...
        <tr>
            <td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width: 60%; padding-left: 20px;" class="Page_Header"><b>Teacher Creation</b> </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td align="center">
                            ...
                            <table border='0' cellpadding="4" width="90%">
                                <tr>
                                     <td class="Display_Caption" align="left">Teacher Code</td>
                                    <td align="left">
                                        <asp:TextBox ID="txtTcode" runat="server" CssClass="textbox" Width="135px"></asp:TextBox>
                                    </td>
                                </tr>
                                 <tr>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnCreateTeacher" runat="server" CssClass="button-new"
                                            Text="Create Teacher" OnClientClick="return checkfield();" OnClick="btnCreate_Click"></asp:Button>
                                        &nbsp;&nbsp;<asp:Button ID="btnbak" runat="server" Text="Back" CssClass="button-new" OnClick="btnbak_Click"/>
                                        <br />
