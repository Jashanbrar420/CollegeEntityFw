...
public partial class Teacher_CreateTeacher : System.Web.UI.Page
{
    ...
    protected void btnCreate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            mst.Emp_Code = txtTcode.Text.Trim();
            ...
            TeacherMsts tmst = new TeacherMsts();
            String strerr = tmst.CreateTeacher(mst);
            if (strerr == "0")
            {
    ...
    private String[] Upload(FileUpload FileUpload_NAME)
    {
        ...
        bool IsExt = false;
        String lstrPath = Server.MapPath("~/TeacherImages/");
