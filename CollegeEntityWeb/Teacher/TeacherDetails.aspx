<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="TeacherDetails.aspx.cs" Inherits="Teacher_TeacherDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table cellpadding="0" cellspacing="0" align="left" style="vertical-align: top;"
        width="100%">
        <tr>
            <td colspan="6" style="padding-right: 10px; width: 944px;" class="Page_Header" align="left">Teacher Details&nbsp;
                <asp:Button ID="btnCreate" runat="server" Text="Create Teacher"
                    CssClass="button-new" ValidationGroup="a" OnClick="btnCreateTeacher_Click" />
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6" align="left" style="height: 10px;">
                <asp:GridView Width="100%" ID="grdTeacherInfo" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:BoundField HeaderText="Teacher Code" DataField="Emp_Code">
                        ...
                        <asp:TemplateField HeaderText="Image">
                            <ItemTemplate>
                                 <asp:ImageButton ID="Imgdownload" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/download.png" ToolTip="Edit Teacher"
                    ...
                    <%--    <asp:BoundField HeaderText="Image" DataField="Image">
                        ...
                        <asp:TemplateField HeaderText="View">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton4" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/delete.png" ToolTip="Delete Teacher"
                                    Height="30" Text="Delete Teacher" OnClick="makelink_delete" CommandArgument='<%# Eval("TeacherID").ToString()%>' />
                                <asp:ImageButton ID="imgView" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/view.png" ToolTip="view Teacher"
                                    Height="30" Text="Delete Teacher" OnClick="makelink_View" CommandArgument='<%# Eval("TeacherID").ToString()%>' />&nbsp;&nbsp;
                                  <asp:ImageButton ID="ImgEdit" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/edit.png" ToolTip="Edit Teacher"
                                      Height="30" Text="Delete Teacher" OnClick="makelink_edit" CommandArgument='<%# Eval("TeacherID").ToString()%>' />
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Height="14px" VerticalAlign="Top" Width="10%" />
                        </asp:TemplateField>
