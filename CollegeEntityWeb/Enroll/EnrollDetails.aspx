<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="EnrollDetails.aspx.cs" Inherits="Enroll_EnrollDetails" %>
            ...
            <td colspan="6" align="left" style="height: 10px;">
                <asp:GridView Width="100%" ID="grdTeacherInfo" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Teacher Name" DataField="TeacherMst.FirstName">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="5%" />
                        </asp:BoundField>
