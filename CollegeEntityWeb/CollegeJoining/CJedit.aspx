<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="CJedit.aspx.cs" Inherits="CollegeJoining_CJedit" %>
        ...
        <tr>
            <td>
                ...
                <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width: 60%; padding-left: 20px;" class="Page_Header"><b>Teacher Joining Edition</b> </td>
                    </tr>
                </table>
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnCreate" runat="server" CssClass="button-new"
                                            Text="Update Joinning" OnClientClick="return checkfield();" OnClick="btnCreate_Click" ></asp:Button>
