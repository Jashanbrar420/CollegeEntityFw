<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="CollegeDetails.aspx.cs" Inherits="College_CollegeDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="0" cellspacing="0" align="left" style="vertical-align: top;"
        width="100%">
        <tr>
            <td colspan="6" style="padding-right: 10px; width: 944px;" class="Page_Header" align="left"> College List&nbsp;
                <asp:Button ID="btnCreateTeacherAdd" runat="server" Text="Create College"
        ...
        <tr>
            <td colspan="6" align="left" style="height: 10px;">
                <asp:GridView Width="100%" ID="grdTeacherInfo" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:BoundField HeaderText="Collage ID" DataField="CollegeID">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="5%" />
                        </asp:BoundField>
                        <asp:BoundField HeaderText="Collage Name" DataField="CollegeName">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="10%" />
                        </asp:BoundField>
                        ...
                        <asp:BoundField HeaderText="Collage Details" DataField="CollegeDesc">
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="5%" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="View">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton4" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/delete.png" ToolTip="Delete Collage"
                                    Height="30" Text="Delete Collage" OnClick="makelink_delete" CommandArgument='<%# Eval("CollegeID").ToString()%>' />
                                  <asp:ImageButton ID="ImgEdit" BorderWidth="0" runat="server" ImageUrl="~/UIFiles/images/edit.png" ToolTip="Edit Collage"
                                      Height="30" Text="Delete Collage" OnClick="makelink_edit" CommandArgument='<%# Eval("CollegeID").ToString()%>' />
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Left" />
