<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="StateCreate.aspx.cs" Inherits="State_StateCreate" %>
                                ...
                                <tr>
                                    <td colspan="6" align="center">
                                        <asp:Button ID="btnstate" runat="server" CssClass="button-new"
                                            Text="Create State" OnClientClick="return checkfield();" OnClick="btnstate_Click"  ></asp:Button>
