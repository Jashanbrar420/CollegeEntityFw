<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="StateDetails.aspx.cs" Inherits="State_StateDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table cellpadding="0" cellspacing="0" align="left" style="vertical-align: top;"
        width="100%">
        <tr>
            <td colspan="6" style="padding-right: 10px; width: 944px;" class="Page_Header" align="left">State List&nbsp;
